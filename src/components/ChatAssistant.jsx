            ...
            <div className="flex flex-col gap-2 mt-2">
              {steps[step]?.options?.map((opt) => (
                <button 
                  ...
                  className="bg-white/5 hover:bg-neon-fuchsia text-white text-left p-3 rounded-xl border border-white/10 text-xs transition-all hover:pl-4"
                >
                  {opt}
                </button>
              ))}
              ...
              {steps[step]?.isFinal && (
                <button 
                  ...
                  className="bg-neon-fuchsia text-white p-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-neon-orange transition-all uppercase text-xs shadow-neon-pink"
                >
